          ...
          children: [
            Positioned(
              ...
              child: Container(
                ...
                color: Color.fromARGB(255, 117, 131, 162).withOpacity(0.85),
                child: Column(
                               ...
                               child: Column(
                                 children:  [
                                   ...
                                   style: GoogleFonts.nunito(
                                     ...
                                     color:isSignupScreen ? Colors.grey : Colors.green.shade300,
                                   ),
                                   ),
                                   if(!isSignupScreen)
                                   Container(
                               ...
                               child: Column(
                                 children:  [
                                   ...
                                   style: GoogleFonts.nunito(
                                     fontSize: 16,
                                     fontWeight: FontWeight.bold,
                                     color:isSignupScreen ? Colors.green.shade300 : Colors.grey,
                                   ),
                                   ),
                                   if(isSignupScreen)
                                   Container(
            ...
            if (result!=null){
              ...
              fontSize: 10.0);
                      ...
                      if(_formKey.currentState!.validate()) {
                       try{
            var result = await FirebaseAuth.instance.signInWithEmailAndPassword(email: _emailLogincontroller.text,password: _passwordLogincontroller.text);
            if(result!=null){
                    ...
                    child: Container(
                     decoration: BoxDecoration(
                       gradient:  LinearGradient(
                         colors: [Colors.green.shade300 , Colors.grey],
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: isVisitor ? Colors.green.shade300 : Colors.transparent,
                                      border: Border.all(
                                        width: 1,
                                        color: isVisitor ?Colors.transparent : Colors.green.shade300
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    child: Icon(
                                      Icons.person,
                                      color:isVisitor ? Colors.green.shade300 : Colors.white,
                                    ),
                                  ),
                                   Text("Parking Owner",
                              style: GoogleFonts.nunito (color: Colors.black,
