                      ...
                      TextButton(
                        onPressed: () {
                          ...
                          if (DateFormat("yyyy/MM/dd HH:mm")
                              .parse(startDate!)
                              .isAfter(DateFormat("yyyy/MM/dd HH:mm")
                                  .parse(finishDate))) {
                            Fluttertoast.showToast(
                              ...
                              .parse(startDate)
                              .isAtSameMomentAs(DateFormat("yyyy/MM/dd HH:mm")
                                  .parse(finishDate))) {
                            Fluttertoast.showToast(
                            ...
                            controller.makePayment(
                                amount:
                                    (int.parse(widget.tarif) * multipleTarif)
                                        .toString(),
                                currency: 'eur');
                          }
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            if ((current_user != null)) {
                              await FirebaseFirestore.instance
                                  .collection("reservation")
                                  .where("park",
                                      isEqualTo: "/parking/" + widget.idPark)
                                  .where("idPlace", isEqualTo: selectedItem)
                                  .snapshots()
                                  .listen((event) async {
                                if (event.docs.isEmpty) {
